...
public class CancelOrderByStudentTests extends AbstractContainerConfig implements IOrderTest {
    ...
    @Autowired
     public  CancelOrderByStudentTests (IUserDao iAdminDao, IFunctionDao iFunctionDao, IPaymentDao iPaymentDao, IOrderDao iOrderDao, IUserDao studentDao, IStudentClassDao studentClassDao, MockMvc mockMvc, IMealDao mealDao, IMenuDao menuDao, ITaxDao taxDao) throws Exception {

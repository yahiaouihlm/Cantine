    ...
    Environment environment;
     ...
     void getMealByIdWithNoutFoundID ()  {
         final   Integer idMeal = Integer.MAX_VALUE;
          ...
          Assertions.assertThrows(MealNotFoundAdminException.class ,  ()-> { this.iMealService.getMealByID(idMeal);});
     ...
     void getMealIdWithInvalidID () {
         Integer IdTest  = -1 ;
          Assertions.assertThrows(InvalidMealInformationAdminException.class ,  ()-> { this.iMealService.getMealByID(IdTest);});

...
import fr.sqli.cantine.service.users.admin.exceptions.InvalidStudentClassException;
import fr.sqli.cantine.service.users.admin.exceptions.StudentClassNotFoundException;
...
*/
    ...
    ResponseEntity<StudentDtout> getStudentById(Integer id) throws StudentNotFoundException, InvalidUserInformationException;
     ...
     ResponseEntity<ResponseDtout> signUpStudent(StudentDtoIn studentDtoIn) throws InvalidUserInformationException, InvalidStudentClassException, InvalidFormatImageException, InvalidImageException, StudentClassNotFoundException, ImagePathException, IOException, ExistingStudentException;
}
